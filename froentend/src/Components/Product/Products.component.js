        ...
        return (
            <>
                <div class="uren-product_area">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="product-slider uren-slick-slider slider-navigation_style-1 img-hover-effect_area slick-carousel-1 slick-initialized slick-slider" data-slick-options="{
                                &quot;slidesToShow&quot;: 6,
                                &quot;arrows&quot; : true
                                    ...
                                    <button class="tty-slick-text-btn tty-slick-text-prev slick-arrow slick-disabled" aria-disabled="true" style={{display: 'block'}}>
                                    ...
                                    <div class="single-product">
                                        <div class="product-img" >
                                            ...
                                            <div class="sticker-area-2">
                                               ...
                                               {products.type ? <span class="sticker">{products.type}</span> :'' }
                                            </div>
                        ...
                        <div class="slick-slide slick-active" data-slick-index="1" aria-hidden="false" style={{width: '324px'}}>
                            <div>
                                <div class="product-slide_item" style={{width: '100%', display: 'inlineBlock'}}>
                                    <div class="inner-slide">
                                        <div class="single-product">
                    ...
                    <button class="tty-slick-text-btn tty-slick-text-next slick-arrow" style={{display: 'block'}} aria-disabled="false"><i class="ion-ios-arrow-forward"></i></button></div>
                    </div>    
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                &quot;arrows&quot; : true
                                    ...
                                    </div></div></div><div class="slick-slide slick-active last-active" data-slick-index="1" aria-hidden="false" style={{width: '647px'}}><div><div class="slide-item" style={{width: '100%', display: 'inlineBlock'}}>
                                        <div class="inner-slide">
                                            <div class="single-product">
                                                <div class="product-img">
                                                    <a href="single-product.html" tabindex="0">
                                    ...
                                    </div></div></div><div class="slick-slide" data-slick-index="2" aria-hidden="true" style={{width: '647px'}} tabindex="-1"><div><div class="slide-item" style={{width: '100%', display: 'inlineBlock'}}>
                                        <div class="inner-slide">
                                            <div class="single-product">
                                                <div class="product-img">
