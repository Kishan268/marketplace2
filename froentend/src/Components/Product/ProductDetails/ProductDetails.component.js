				...
				<div class="col-md-4" style={{ fontSize: '130%'}}>
					...
					<div class="card mt-2">
						...
						<div class="card-body">
							...
							<button onClick={()=>{props.addToCartHandler({pro_id:products.pro_id,name:products.name,price:products.price})}} type="button" class="btn btn-warning qty-cart_btn btn-sm  mb-2">
						...
						<div class="card-body">
							...
							<button onClick={()=>{props.addToCartHandler({pro_id:products.pro_id,name:products.name,price:products.price,qty:1})}} type="button" class="btn btn-warning qty-cart_btn btn-sm  mb-2">
