...
class Checkout extends Component {
    ...
    const cartDatas =userInfo.data.cardData
     ...
     <div>  
            ...
            <div className="col-md-12">
                <div className="checkout-form-list">
                    ...
                    <input placeholder="" type="text" name="f_name"/>
                </div>
            </div>
            <div className="col-md-12">
                <div className="checkout-form-list">
                    <label>Last Name <span className="required">*</span></label>
                    <input placeholder="" type="text" name="l_name"/>
                </div>
            </div>
                                ...
                                <div className="coupon-info">
                                    ...
                                    <form action="javascript:void(0)">
                                        ...
                                        <p className="lost-password">
                                            <a href="javascript:void(0)">Lost your password?</a></p>
                                    </form>
                                </div>
                            </div>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-12">
                                        <div className="checkout-form-list">
                                            <label>Country <span className="required">*</span></label>
                                            <input placeholder=""
                                             type="text" value={userInfo?userInfo.country:''}/>
                                        </div>
                                    </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="checkout-form-list">
                                            <label>First Name <span className="required">*</span></label>
                                            <input placeholder="" type="text" value={userInfo?userInfo.f_name:''}/>
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="checkout-form-list">
                                            <label>Last Name <span className="required">*</span></label>
                                            <input placeholder="" type="text" value={userInfo?userInfo.l_name:''}/>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-md-12">
                                        <div className="checkout-form-list">
                                            <label>Address <span className="required">*</span></label>
                                            <input placeholder="Street address" type="text" value={userInfo?userInfo.address:''}/>
                                        </div>
                                    </div>
                                    <div className="col-md-12">
                                        <div className="checkout-form-list">
                                    ...
                                    <div className="col-md-12">
                                        <div className="checkout-form-list">
                                            <label>Town / City <span className="required" >*</span></label>
                                            <input type="text" value={userInfo?userInfo.city:''}/>
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="checkout-form-list">
                                            <label>State / County <span className="required">*</span></label>
                                            <input placeholder="" type="text" value={userInfo?userInfo.state:''}/>
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="checkout-form-list">
                                            <label>Postcode / Zip <span className="required">*</span></label>
                                            <input placeholder="" type="text" value={userInfo?userInfo.zip:''}/>
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="checkout-form-list">
                                            <label>Email Address <span className="required">*</span></label>
                                            <input placeholder="" type="email" value={userInfo?userInfo.email:''}/>
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="checkout-form-list">
                                            <label>Phone <span className="required">*</span></label>
                                            <input type="text" value={userInfo?userInfo.phone_no:''}/>
                                        </div>
                                    </div>
                                {/* {    <div className="col-md-12">
                                        ...
                                        <div id="cbox-info" className="checkout-form-list create-account"  style={{display: 'none'}}>
                                ...
                                <div className="different-address">
                                    <div className="ship-different-title">
                                        <h3>
                                            ...
                                            <input id="ship-box"  type="checkbox"  checked={ this.state.checked }  onChange={ this.handleChange } value={'sdfds'}/>
                                        </h3>
                                         { content }
                                    </div>
                            ...
                            <div className="your-order-table table-responsive">
                                <table className="table">
                                    ...
                                    <tr className="cart_item">
                                        ...
                                        × {cartData.qty}</strong></td>
                                        <td className="cart-product-total"><span className="amount">${cartData.price*cartData.qty}</span></td>
                                    ...
                                    <tfoot>
                                        <tr className="cart-subtotal">
                                            <th>Cart Subtotal</th>
                                            <td><span className="amount">${cartDatas.price*cartDatas.qty}</span></td>
                                        </tr>
                                        <tr className="order-total">
                                            <th>Order Total</th>
                                            <td><strong><span className="amount">${cartDatas.price*cartDatas.qty}</span></strong></td>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
